...
public class ShapeFile2CSVConverterDataProcessorFactory implements DataFlowNodeFactory
{
    public ShapeFile2CSVConverterDataProcessorFactory(String name, Map<String, String> properties)
    {
        _name       = name;
    ...
    {
        if (dataFlowNodeClass.isAssignableFrom(ShapeFile2CSVConverterDataProcessor.class))
            return (T) new ShapeFile2CSVConverterDataProcessor(name, properties);
        else
            return null;
    }
